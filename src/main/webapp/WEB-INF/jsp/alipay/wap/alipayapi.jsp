...
<%@ page import="com.jkm.util.alipay.config.*"%>
<%@ page import="com.jkm.util.alipay.util.*"%>
<%@ page import="java.util.HashMap"%>
<%@ page import="java.util.Map"%>
<%@ page import="com.jkm.util.alipay.util.AlipaySubmit" %>
<%@ page import="com.jkm.util.alipay.config.AlipayConfig" %>
<!DOCTYPE html>
<html>
	<head>
