package com.jkm.entity.fusion.head;
...
@XmlType(name = "INFO", propOrder={"trxCode", "version", "dataType", "level", "userName", "userPass", "reqSn", "signedMsg","merchantId"})

public class RequestHead20005 {
	// 交易码
	...
	public String toString() {
		return "RequestHead [trxCode=" + trxCode + ", version=" + version
				+ ", dataType=" + dataType + ", level=" + level + ", userName="
				+ userName + ", userPass=" + userPass + ", reqSn=" + reqSn
				+ ", signedMsg=" + signedMsg + ", merchantId=" + merchantId + "]";
	}
}