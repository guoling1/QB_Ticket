 ...
 * 处理抢票单部分退款的消息
 */
public class MessageListenerTGrabPartRefundImpl implements MessageListener {

    private static Logger log = Logger.getLogger(MessageListenerTGrabPartRefundImpl.class);
    @Autowired
