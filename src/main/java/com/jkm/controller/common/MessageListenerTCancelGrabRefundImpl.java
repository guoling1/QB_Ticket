 ...
 */
public class MessageListenerTCancelGrabRefundImpl implements MessageListener {

    private static Logger log = Logger.getLogger(MessageListenerTCancelGrabRefundImpl.class);
    @Autowired
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        try {
            ...
            log.info("消费[取消抢票单全额退款的消息[" + jo.getLong("grabTicketFormId") + "]退款在请求中的消息]");
